...
public class AgrupacionRangoFechas {
    ...
    public List<GestionRangoFechas> agruparRangoFechas(List<GestionRangoFechas> lstRangosDeFechas) {
        ...
        Collections.sort(lstRangosDeFechas, Comparator.comparing(rangoDeFechas -> rangoDeFechas.inicioDelRango));
        ...
        for (int i = 1; i < lstRangosDeFechas.size(); i++) {
            ...
            if (!actualRangoDeFechas.finDelRango.before(siguienteRangoDeFechas.inicioDelRango)) {
                actualRangoDeFechas.finDelRango = actualRangoDeFechas.finDelRango.after(siguienteRangoDeFechas.finDelRango) ? actualRangoDeFechas.finDelRango : siguienteRangoDeFechas.finDelRango;
            } else {
